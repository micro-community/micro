...
import (
	...
	inApiHandler "github.com/micro-community/micro/v3/service/api/server/handler"
	inApiResolver "github.com/micro-community/micro/v3/service/api/server/resolver"
	inApiRouter "github.com/micro-community/micro/v3/service/api/server/router"
	inApiServer "github.com/micro-community/micro/v3/service/api/server/server"

	inApiHandlerApi "github.com/micro-community/micro/v3/service/api/server/handler/api"
	inApiHandlerEvent "github.com/micro-community/micro/v3/service/api/server/handler/event"
	inApiHandlerHttp "github.com/micro-community/micro/v3/service/api/server/handler/http"
	inApiHandlerRpc "github.com/micro-community/micro/v3/service/api/server/handler/rpc"
	inApiHandlerWeb "github.com/micro-community/micro/v3/service/api/server/handler/web"

	inApiResolverGrpc "github.com/micro-community/micro/v3/service/api/server/resolver/grpc"
	inApiResolverHost "github.com/micro-community/micro/v3/service/api/server/resolver/host"
	inApiResolverPath "github.com/micro-community/micro/v3/service/api/server/resolver/path"
	inApiResolverSubDomain "github.com/micro-community/micro/v3/service/api/server/resolver/subdomain"

	inApiRouterReg "github.com/micro-community/micro/v3/service/api/server/router/registry"
	inApiServerHttp "github.com/micro-community/micro/v3/service/api/server/server/http"
